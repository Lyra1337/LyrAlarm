...
namespace LyraAlarmApp
{
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (localSettings.Values.ContainsKey("first-launch") == false)
            {
                this.FirstTimeSetup();
                localSettings.Values.Add("first-launch", true);
            }
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                if (!rootFrame.Navigate(typeof(AlarmOverview), e.Arguments))
                {
